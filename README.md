...
| `be0c74ae3` `0a9c80dce` `ddccce961` | libEGL + libxshmfence thunks wired into the build + ThunksDB catalog. libEGL was already built but missing from the catalog; libxshmfence (7 fns — DRI3 explicit-sync) was source-only, never compiled. |
